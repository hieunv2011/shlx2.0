...
const CourseSearch = ({ onSubmitName, onSubmitId, onSelectStatus }) => {
    ...
    <div className="flex space-x-2 max-phone:flex-col max-phone:space-x-0 space-y-2">
      <div className="flex space-x-2">
        <div className="">
          ...
          <input
            type="text"
            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-md block w-60 p-2.5 h-[38px] max-phone:w-40"
